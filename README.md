...
**Route review (v3.26):** In Simulate → Live material flow, review each order recipe against the current floor. Every operation shows placed, shared, fallback, missing or unsupported equipment; returns show both outcomes. A drawable route is not proof of an operational facility. Playback remains the default teaching route. See [factory research and implementation limits](docs/FACTORY_RESEARCH_2026-09.md).
...
Cachewt-v108;56Node,19Python,159browser checks pass. Actual import and stale rejection
