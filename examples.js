...
(function () {
  ...
  const LIBRARY = [
    {
      ...
      config: { profile: "automotive-supply", seed: 101, minAisle: 3.0, racking: ["selective-racking", "pallet-flow", "drive-in"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.35, "case-pick": 0.35, "cross-dock": 0.2, "vas": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 202, minAisle: 2.9, racking: ["selective-racking", "carton-flow", "mezzanine"], transport: "agv", adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.6, "case-pick": 0.15, "returns": 0.15, "vas": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 303, minAisle: 1.8, racking: ["mobile-racking", "drive-in", "selective-racking"], transport: null, adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.5, "case-pick": 0.4, "cross-dock": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "spare-parts-distribution", seed: 404, minAisle: 1.8, racking: ["selective-racking", "carton-flow", "shuttle"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.7, "case-pick": 0.15, "export-fragile": 0.1, "returns": 0.05 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 505, minAisle: 2.0, racking: ["selective-racking", "carton-flow", "mobile-racking"], transport: "agv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "case-pick": 0.45, "piece-pick": 0.3, "full-pallet-out": 0.1, "returns": 0.1, "export-fragile": 0.05 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 606, minAisle: 2.9, racking: ["selective-racking", "pallet-flow"], transport: "agv", adds: [{ type: "staging", zone: "picking", count: 2 }, { type: "push-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "cross-dock": 0.65, "full-pallet-out": 0.25, "case-pick": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 707, minAisle: 1.8, racking: ["drive-in", "pallet-flow", "block-stack"], transport: null, adds: [{ type: "staging", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.7, "case-pick": 0.25, "returns": 0.05 } },
    ...
    },
    {
      ...
      config: { profile: "automotive-supply", seed: 808, minAisle: 2.9, racking: ["asrs", "shuttle", "selective-racking"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.55, "case-pick": 0.35, "cross-dock": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 909, minAisle: 2.9, racking: ["cantilever", "block-stack", "selective-racking"], transport: null, adds: [{ type: "staging", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.4, "case-pick": 0.3, "vas": 0.1, "returns": 0.2 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 111, minAisle: 3.0, racking: ["selective-racking", "block-stack", "selective-racking"], transport: null, adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.5, "case-pick": 0.35, "export-fragile": 0.15 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 222, minAisle: 2.0, racking: ["selective-racking", "carton-flow", "mezzanine"], transport: "agv", adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.5, "case-pick": 0.25, "vas": 0.1, "returns": 0.15 } },
    ...
    },
    {
      ...
      config: { profile: "automotive-supply", seed: 333, minAisle: 3.0, racking: ["cantilever", "drive-in", "selective-racking"], transport: "rgv", adds: [{ type: "staging", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.45, "case-pick": 0.45, "cross-dock": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 444, minAisle: 2.0, racking: ["pallet-flow", "drive-in", "carton-flow"], transport: "agv", adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "case-pick": 0.6, "full-pallet-out": 0.3, "cross-dock": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "spare-parts-distribution", seed: 555, minAisle: 1.8, racking: ["shuttle", "carton-flow", "selective-racking"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.5, "case-pick": 0.25, "export-fragile": 0.15, "vas": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 666, minAisle: 2.9, racking: ["selective-racking", "carton-flow", "mezzanine"], transport: "agv", adds: [{ type: "staging", zone: "picking", count: 2 }, { type: "push-station", zone: "picking", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "vas-station", zone: "packing", count: 1 }], orderMix: { "returns": 0.7, "piece-pick": 0.2, "vas": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 777, minAisle: 1.8, racking: ["mezzanine", "carton-flow", "shuttle"], transport: "agv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }], orderMix: { "piece-pick": 0.85, "returns": 0.15 } },
    ...
    },
    {
      ...
      config: { profile: "spare-parts-distribution", seed: 888, minAisle: 2.9, racking: ["selective-racking", "cantilever", "carton-flow"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.5, "export-fragile": 0.3, "returns": 0.2 } },
    ...
    },
    {
      ...
      config: { profile: "automotive-supply", seed: 999, minAisle: 2.0, racking: ["pallet-flow", "selective-racking", "mobile-racking"], transport: "agv", adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.5, "case-pick": 0.4, "cross-dock": 0.1 } },
    ...
    },
    {
      ...
      config: { profile: "ecommerce-fulfilment", seed: 121, minAisle: 2.0, racking: ["carton-flow", "double-deep", "selective-racking"], transport: "agv", adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "piece-pick": 0.45, "case-pick": 0.35, "returns": 0.2 } },
    ...
    },
    {
      ...
      config: { profile: "spare-parts-distribution", seed: 232, minAisle: 2.0, racking: ["selective-racking", "double-deep", "carton-flow"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "case-pick": 0.4, "piece-pick": 0.4, "full-pallet-out": 0.2 } },
    ...
    },
    {
      ...
      config: { profile: "cold-chain", seed: 343, minAisle: 3.0, racking: ["drive-in", "block-stack", "selective-racking"], transport: null, adds: [{ type: "push-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.6, "export-fragile": 0.25, "case-pick": 0.15 } },
    ...
    },
    {
      ...
      config: { profile: "automotive-supply", seed: 454, minAisle: 2.9, racking: ["push-back", "drive-in", "selective-racking"], transport: "rgv", adds: [{ type: "pull-station", zone: "picking", count: 1 }, { type: "qc-bench", zone: "receiving", count: 1 }, { type: "depalletiser", zone: "receiving", count: 1 }, { type: "returns-station", zone: "receiving", count: 1 }, { type: "stretch-wrap", zone: "packing", count: 1 }], orderMix: { "full-pallet-out": 0.4, "case-pick": 0.5, "returns": 0.1 } },
    ...
    },
    {
      ...
      // 800+ elements, every one of the 32 warehouse element types, overlap-free and
      ...
      config: { mega: true, seed: 20260805, orderMix: { "full-pallet-out": 0.18, "case-pick": 0.22, "piece-pick": 0.3, "cross-dock": 0.12, "returns": 0.1, "vas": 0.05, "export-fragile": 0.03 } },
   ...
   * byte-identical on every run. Every one of the 32 warehouse palette types appears.
   * ================================================================== */
  function generateMegaLayout() {
    ...
    if (flow) {
      ...
      for (let ci = 0; ci < cols.length; ci++) {
        ...
        // v3.29 R2: the goods-in QC bench and the depalletiser stand on the
        // inbound side of the spine, TOUCHING the return conveyor below them
        // (no 1-wide pinch) with >= 2 clear rows above.
        add("qc-bench", ax0, flow.y1 - 4, 3, 2, "picking");
        add("depalletiser", ax0 + 4, flow.y1 - 5, 3, 3, "picking");
      }
    }
    ...
    if (pack) {
      for (let ci = 0; ci < cols.length; ci++) {
        ...
        add("vas-station", ax0 + 10, pack.y0 + 1, 3, 2, "packing"); // v3.29 R2 (touches the gate where one stands)
  ...
  function buildMega(ex) {
    ...
    if (cfg.orderMix) config.orderMix = Object.assign({}, cfg.orderMix); // v3.29 R4
  ...
  function build(id) {
    ...
    // v3.29 R4: the scenario's declared ORDER MIX rides on the config (absent when
    // a scenario declares none, so such a layout stays byte-identical).
    if (cfg.orderMix) config.orderMix = Object.assign({}, cfg.orderMix);
