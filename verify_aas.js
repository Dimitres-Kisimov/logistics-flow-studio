...
(function () {
  ...
  check("7a. index.html loads aas.js before app.js; sw.js precaches it at wt-v145 (trail preserved: previously wt-v144); test/run-all.mjs lists this harness",
    html.indexOf('<script src="aas.js"></script>') > 0 && html.indexOf('<script src="aas.js"></script>') < html.indexOf('<script src="app.js"></script>') &&
    /"\.\/aas\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw) && /verify_aas\.js/.test(runall));
