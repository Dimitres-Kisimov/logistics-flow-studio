...
(function () {
  ...
  check("7a. index.html loads aas.js before app.js; sw.js precaches it at wt-v148 (trail preserved: previously wt-v147); test/run-all.mjs lists this harness",
    html.indexOf('<script src="aas.js"></script>') > 0 && html.indexOf('<script src="aas.js"></script>') < html.indexOf('<script src="app.js"></script>') &&
    /"\.\/aas\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw) && /verify_aas\.js/.test(runall));
