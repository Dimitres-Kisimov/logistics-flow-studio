 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v71 (previously wt-v70),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v71"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v71, selftest has the P-toggle check, run-all lists verify_animation",
