 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v60 (previously wt-v59),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v60"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v60, selftest has the P-toggle check, run-all lists verify_animation",
