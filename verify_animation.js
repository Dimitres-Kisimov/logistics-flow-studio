 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v97 (previously wt-v73),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v97"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v97, selftest has the P-toggle check, run-all lists verify_animation",
