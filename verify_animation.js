 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v58 (previously wt-v57),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v58"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v58, selftest has the P-toggle check, run-all lists verify_animation",
