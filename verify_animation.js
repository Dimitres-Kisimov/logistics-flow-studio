 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v59 (previously wt-v58),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v59"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v59, selftest has the P-toggle check, run-all lists verify_animation",
