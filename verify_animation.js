 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v63 (previously wt-v62),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v63"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v63, selftest has the P-toggle check, run-all lists verify_animation",
