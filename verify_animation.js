 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v72 (previously wt-v71),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v72"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v72, selftest has the P-toggle check, run-all lists verify_animation",
