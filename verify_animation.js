 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v65 (previously wt-v64),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v65"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v65, selftest has the P-toggle check, run-all lists verify_animation",
