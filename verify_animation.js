 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v56 (previously wt-v55),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v56"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v56, selftest has the P-toggle check, run-all lists verify_animation",
