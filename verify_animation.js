 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v69 (previously wt-v68),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v69"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v69, selftest has the P-toggle check, run-all lists verify_animation",
