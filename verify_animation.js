 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v51 (previously wt-v50),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v51"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v51, selftest has the P-toggle check, run-all lists verify_animation",
