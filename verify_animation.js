 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v70 (previously wt-v69),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v70"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v70, selftest has the P-toggle check, run-all lists verify_animation",
