 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v61 (previously wt-v60),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v61"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v61, selftest has the P-toggle check, run-all lists verify_animation",
