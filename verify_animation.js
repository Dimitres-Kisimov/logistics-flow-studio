 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v49 (previously wt-v48),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v49"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v49, selftest has the P-toggle check, run-all lists verify_animation",
