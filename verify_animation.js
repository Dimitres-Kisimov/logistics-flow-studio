 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v66 (previously wt-v65),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v66"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v66, selftest has the P-toggle check, run-all lists verify_animation",
