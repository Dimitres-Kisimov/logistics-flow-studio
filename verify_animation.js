 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v54 (previously wt-v53),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v54"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v54, selftest has the P-toggle check, run-all lists verify_animation",
