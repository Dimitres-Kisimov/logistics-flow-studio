 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v47,
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v47"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v47, selftest has the P-toggle check, run-all lists verify_animation",
