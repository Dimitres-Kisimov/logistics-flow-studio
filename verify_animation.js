 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v55 (previously wt-v54),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v55"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v55, selftest has the P-toggle check, run-all lists verify_animation",
