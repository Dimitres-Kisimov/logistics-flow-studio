 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v52 (previously wt-v51),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v52"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v52, selftest has the P-toggle check, run-all lists verify_animation",
