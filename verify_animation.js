 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v57 (previously wt-v56),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v57"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v57, selftest has the P-toggle check, run-all lists verify_animation",
