 ...
 *  14. shipped wiring: index.html isoBtn mentions "P", sw.js is wt-v64 (previously wt-v63),
...
(() => {
  ...
  const swBump = /CACHE_VERSION\s*=\s*"wt-v64"/.test(SW_SRC);
  ...
  check("shipped wiring: isoBtn advertises P, sw.js is wt-v64, selftest has the P-toggle check, run-all lists verify_animation",
