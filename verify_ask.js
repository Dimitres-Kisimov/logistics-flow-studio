 ...
 *      self-tests, run-all, sw.js at wt-v142, README, CHANGELOG, the doc.
...
(function () {
  ...
  check("6c. both self-tests, run-all, sw.js precaches ask.js at wt-v142 (previously wt-v141), the styles, README and CHANGELOG name v3.60, docs/ASK_THE_LEDGER.md exists",
    /ask-the-ledger-deterministic/.test(st) && /ask-section-answers-on-example-a/.test(rlst) && /"rlAskOut"/.test(rlst) && /verify_ask\.js/.test(runall) && /"\.\/ask\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw) &&
