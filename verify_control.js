 ...
 *      the runner, sw.js at wt-v141, README / CHANGELOG / the deep dive's
...
(function () {
  ...
  check("6e. the viewer: the Control tower block with its note, the glance card; both self-tests; run-all; sw.js precaches control.js at wt-v141 (previously wt-v140)",
    ...
    /Object\.keys\(R\.SQL\)\.length === 37/.test(vst) && /verify_control\.js/.test(runall) && /"\.\/control\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v141"/.test(sw) && /Previously wt-v140/.test(sw));
