 ...
 *      every view the SQLite tool defines; sw.js at wt-v118; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
const near = (a, b, tol) => Math.abs(a - b) <= (tol == null ? 5e-4 : tol);
...
(function () {
  ...
  check("4b. the viewer page loads ledger.js before run-ledger.js and has the cost section", /<script src="ledger\.js"><\/script>(<script src="analytics\.js"><\/script>)?<script src="run-ledger\.js">/.test(html) && /id="rlCost"/.test(html));
  ...
  check("4e. sw.js at wt-v118 (previously wt-v117) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v118"/.test(sw) && /Previously wt-v117/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
