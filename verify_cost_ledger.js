 ...
 *      every view the SQLite tool defines; sw.js at wt-v119; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v119 (previously wt-v118) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v119"/.test(sw) && /Previously wt-v118/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
