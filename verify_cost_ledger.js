 ...
 *      every view the SQLite tool defines; sw.js at wt-v123; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v123 (previously wt-v122) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v123"/.test(sw) && /Previously wt-v122/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
