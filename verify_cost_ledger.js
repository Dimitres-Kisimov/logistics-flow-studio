 ...
 *      every view the SQLite tool defines; sw.js at wt-v124; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v124 (previously wt-v123) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v124"/.test(sw) && /Previously wt-v123/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
