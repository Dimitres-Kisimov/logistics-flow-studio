 ...
 *      every view the SQLite tool defines; sw.js at wt-v138; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v138 (previously wt-v137) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
