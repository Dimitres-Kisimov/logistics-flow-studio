 ...
 *      every view the SQLite tool defines; sw.js at wt-v128; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v128 (previously wt-v127) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v128"/.test(sw) && /Previously wt-v127/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
