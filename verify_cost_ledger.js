 ...
 *      every view the SQLite tool defines; sw.js at wt-v117; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4b. the viewer page loads ledger.js before run-ledger.js and has the cost section", /<script src="ledger\.js"><\/script><script src="run-ledger\.js">/.test(html) && /id="rlCost"/.test(html));
  ...
  check("4e. sw.js at wt-v117 (previously wt-v116) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v117"/.test(sw) && /Previously wt-v116/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
