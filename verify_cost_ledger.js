 ...
 *      every view the SQLite tool defines; sw.js at wt-v127; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v127 (previously wt-v126) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v127"/.test(sw) && /Previously wt-v126/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
