 ...
 *      every view the SQLite tool defines; sw.js at wt-v146; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v146 (previously wt-v145) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
