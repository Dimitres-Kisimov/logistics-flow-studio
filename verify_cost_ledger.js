 ...
 *      every view the SQLite tool defines; sw.js at wt-v143; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4b. the viewer page loads ledger.js before run-ledger.js and has the cost section", /<script src="ledger\.js"><\/script>(<script src="tracking\.js"><\/script>)?(<script src="control\.js"><\/script>)?(<script src="ask\.js"><\/script>)?(<script src="analytics\.js"><\/script>)?<script src="run-ledger\.js">/.test(html) && /id="rlCost"/.test(html));
  ...
  check("4e. sw.js at wt-v143 (previously wt-v142) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v143"/.test(sw) && /Previously wt-v142/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
