 ...
 *      every view the SQLite tool defines; sw.js at wt-v125; the runner.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("4e. sw.js at wt-v125 (previously wt-v124) still precaches ledger.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v125"/.test(sw) && /Previously wt-v124/.test(sw) && /"\.\/ledger\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
