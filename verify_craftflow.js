 ...
 *           sw.js is at the bumped wt-v107 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v107 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v107"/.test(sw) && /Previously wt-v73/.test(sw));
