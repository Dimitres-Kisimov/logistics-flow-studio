 ...
 *           sw.js is at the bumped wt-v122 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v122 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v122"/.test(sw) && /Previously wt-v73/.test(sw));
