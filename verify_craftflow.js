 ...
 *           sw.js is at the bumped wt-v94 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v94 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v94"/.test(sw) && /Previously wt-v73/.test(sw));
