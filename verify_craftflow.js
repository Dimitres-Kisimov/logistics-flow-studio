 ...
 *           sw.js is at the bumped wt-v104 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v104 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v104"/.test(sw) && /Previously wt-v73/.test(sw));
