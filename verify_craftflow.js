 ...
 *           sw.js is at the bumped wt-v144 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v144 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v73/.test(sw));
