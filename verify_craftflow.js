 ...
 *           sw.js is at the bumped wt-v112 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v112 (trail preserved: previously wt-v73)",
    /CACHE_VERSION\s*=\s*"wt-v112"/.test(sw) && /Previously wt-v73/.test(sw));
