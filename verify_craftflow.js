 ...
 *           sw.js is at the bumped wt-v73 cache, the runner lists this
...
/* ---- 13. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js cache is at the bumped wt-v73 (trail preserved: previously wt-v72)",
    /CACHE_VERSION\s*=\s*"wt-v73"/.test(sw) && /Previously wt-v72/.test(sw));
