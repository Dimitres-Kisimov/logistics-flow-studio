 ...
 *      both self-tests, the runner, sw.js at wt-v136 precaching the dataset
...
(function () {
  ...
  check("7f. both self-tests cover it; run-all lists this harness; sw.js precaches the dataset twin at wt-v136 (previously wt-v135)",
    ...
    /"\.\/data\/scms-delivery\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v136"/.test(sw) && /Previously wt-v135/.test(sw));
