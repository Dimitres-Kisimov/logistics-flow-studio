 ...
 *      both self-tests, the runner, sw.js at wt-v147 precaching the dataset
...
(function () {
  ...
  check("7f. both self-tests cover it; run-all lists this harness; sw.js precaches the dataset twin at wt-v147 (previously wt-v146)",
    ...
    /"\.\/data\/scms-delivery\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw));
