 ...
 *      both self-tests, the runner, sw.js at wt-v146 precaching the dataset
...
(function () {
  ...
  check("7f. both self-tests cover it; run-all lists this harness; sw.js precaches the dataset twin at wt-v146 (previously wt-v145)",
    ...
    /"\.\/data\/scms-delivery\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw));
