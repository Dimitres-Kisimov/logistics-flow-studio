 ...
 *      both self-tests, the runner, sw.js at wt-v145 precaching the dataset
...
(function () {
  ...
  check("7f. both self-tests cover it; run-all lists this harness; sw.js precaches the dataset twin at wt-v145 (previously wt-v144)",
    ...
    /"\.\/data\/scms-delivery\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw));
