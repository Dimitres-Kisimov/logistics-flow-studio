 ...
 *      the runner, sw.js at wt-v147, README / CHANGELOG / CREDITS.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8f. sw.js at wt-v147 (previously wt-v146)", /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw));
