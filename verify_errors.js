 ...
 *      the runner, sw.js at wt-v138, README / CHANGELOG / CREDITS.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8f. sw.js at wt-v138 (previously wt-v137)", /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw));
