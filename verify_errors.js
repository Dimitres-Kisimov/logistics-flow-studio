 ...
 *      the runner, sw.js at wt-v135, README / CHANGELOG / CREDITS.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8f. sw.js at wt-v135 (previously wt-v134)", /CACHE_VERSION\s*=\s*"wt-v135"/.test(sw) && /Previously wt-v134/.test(sw));
