 ...
 *      the runner, sw.js at wt-v146, README / CHANGELOG / CREDITS.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8f. sw.js at wt-v146 (previously wt-v145)", /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw));
