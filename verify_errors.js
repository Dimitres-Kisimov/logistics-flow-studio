 ...
 *      the runner, sw.js at wt-v137, README / CHANGELOG / CREDITS.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8f. sw.js at wt-v137 (previously wt-v136)", /CACHE_VERSION\s*=\s*"wt-v137"/.test(sw) && /Previously wt-v136/.test(sw));
