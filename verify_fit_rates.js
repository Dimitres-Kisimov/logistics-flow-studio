 ...
 *      run-all, sw.js at wt-v148, README, CHANGELOG, docs/SITE_PROFILE.md.
...
(function () {
  ...
  check("7c. selftest.js has site-profile-measured-labels; run-all lists verify_fit_rates.js; sw.js at wt-v148 (previously wt-v147); README and CHANGELOG name v3.59; docs/SITE_PROFILE.md exists and names the rule",
    /site-profile-measured-labels/.test(st) && /verify_fit_rates\.js/.test(runall) && /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw) && /v3\.59/.test(readme) && /## v3\.59/.test(changelog) &&
