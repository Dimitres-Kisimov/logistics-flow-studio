 ...
 *     sw.js precaches ./fluids.js at the bumped wt-v112 cache; the
...
/* ---- 11. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js precaches ./fluids.js at the bumped wt-v112 cache",
    /["']\.\/fluids\.js["']/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v112"/.test(sw));
