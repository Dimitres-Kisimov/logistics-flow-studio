 ...
 *     sw.js precaches ./fluids.js at the bumped wt-v72 cache; the
...
/* ---- 11. Shipped wiring ------------------------------------------------- */
{
  ...
  check("sw.js precaches ./fluids.js at the bumped wt-v72 cache",
    /["']\.\/fluids\.js["']/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v72"/.test(sw));
