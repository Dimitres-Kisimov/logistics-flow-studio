 ...
 *      startsInStock, run-all lists this file, sw.js bumped to wt-v114.
 *
...
(function () {
  ...
  check("7c. sw.js cache bumped to wt-v114 (trail preserved: previously wt-v113)",
    /CACHE_VERSION\s*=\s*"wt-v114"/.test(sw) && /Previously wt-v113/.test(sw));
