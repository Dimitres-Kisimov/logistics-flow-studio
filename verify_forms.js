 ...
 *      startsInStock, run-all lists this file, sw.js bumped to wt-v113.
 *
...
(function () {
  ...
  check("7c. sw.js cache bumped to wt-v113 (trail preserved: previously wt-v112)",
    /CACHE_VERSION\s*=\s*"wt-v113"/.test(sw) && /Previously wt-v112/.test(sw));
