 ...
 *       wt-v52 (v2.7 FACTORY-C; previously wt-v51).
...
check(
  "sw.js cache bumped to wt-v52 (and no longer wt-v51)",
  /CACHE_VERSION\s*=\s*"wt-v52"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v51"/.test(swJs),
  "CACHE_VERSION = wt-v52"
);
