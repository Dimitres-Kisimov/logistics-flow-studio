 ...
 *       wt-v118 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v117, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v118 (and no longer wt-v117)",
  /CACHE_VERSION\s*=\s*"wt-v118"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v117"/.test(swJs),
  "CACHE_VERSION = wt-v118"
);
