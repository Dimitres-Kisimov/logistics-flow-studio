 ...
 *       wt-v53 (v2.8 FACTORY-D; previously wt-v52).
...
check(
  "sw.js cache bumped to wt-v53 (and no longer wt-v52)",
  /CACHE_VERSION\s*=\s*"wt-v53"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v52"/.test(swJs),
  "CACHE_VERSION = wt-v53"
);
