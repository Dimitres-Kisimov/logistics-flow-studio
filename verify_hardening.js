 ...
 *       wt-v126 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v125, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v126 (and no longer wt-v125)",
  /CACHE_VERSION\s*=\s*"wt-v126"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v125"/.test(swJs),
  "CACHE_VERSION = wt-v126"
);
