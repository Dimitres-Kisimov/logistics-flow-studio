 ...
 *       wt-v54 (v3.1 ANALYTICS A1; previously wt-v53).
...
check(
  "sw.js cache bumped to wt-v54 (and no longer wt-v53)",
  /CACHE_VERSION\s*=\s*"wt-v54"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v53"/.test(swJs),
  "CACHE_VERSION = wt-v54"
);
