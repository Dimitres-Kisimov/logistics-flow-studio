...
check(
  "sw.js cache bumped to wt-v51 (and no longer wt-v50)",
  /CACHE_VERSION\s*=\s*"wt-v51"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v50"/.test(swJs),
  "CACHE_VERSION = wt-v51"
);
