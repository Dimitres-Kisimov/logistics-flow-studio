 ...
 *       wt-v56 (v3.3 ANALYTICS A3+A4; previously wt-v55).
...
check(
  "sw.js cache bumped to wt-v56 (and no longer wt-v55)",
  /CACHE_VERSION\s*=\s*"wt-v56"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v55"/.test(swJs),
  "CACHE_VERSION = wt-v56"
);
