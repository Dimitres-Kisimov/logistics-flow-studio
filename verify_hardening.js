...
check(
  "sw.js cache bumped to wt-v50 (and no longer wt-v49)",
  /CACHE_VERSION\s*=\s*"wt-v50"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v49"/.test(swJs),
  "CACHE_VERSION = wt-v50"
);
