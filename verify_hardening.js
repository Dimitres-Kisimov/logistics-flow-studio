 ...
 *       wt-v137 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v136, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v137 (and no longer wt-v136)",
  /CACHE_VERSION\s*=\s*"wt-v137"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v136"/.test(swJs),
  "CACHE_VERSION = wt-v137"
);
