 ...
 *       wt-v120 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v119, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v120 (and no longer wt-v119)",
  /CACHE_VERSION\s*=\s*"wt-v120"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v119"/.test(swJs),
  "CACHE_VERSION = wt-v120"
);
