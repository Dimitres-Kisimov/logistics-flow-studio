 ...
 *       wt-v145 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v144, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v145 (and no longer wt-v144)",
  /CACHE_VERSION\s*=\s*"wt-v145"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v144"/.test(swJs),
  "CACHE_VERSION = wt-v145"
);
