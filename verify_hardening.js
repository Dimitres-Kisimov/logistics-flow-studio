 ...
 *       wt-v55 (v3.2 ANALYTICS A2; previously wt-v54).
...
check(
  "sw.js cache bumped to wt-v55 (and no longer wt-v54)",
  /CACHE_VERSION\s*=\s*"wt-v55"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v54"/.test(swJs),
  "CACHE_VERSION = wt-v55"
);
