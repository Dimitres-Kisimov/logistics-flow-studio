 ...
 *       wt-v132 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v131, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v132 (and no longer wt-v131)",
  /CACHE_VERSION\s*=\s*"wt-v132"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v131"/.test(swJs),
  "CACHE_VERSION = wt-v132"
);
