 ...
 *       wt-v136 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v135, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v136 (and no longer wt-v135)",
  /CACHE_VERSION\s*=\s*"wt-v136"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v135"/.test(swJs),
  "CACHE_VERSION = wt-v136"
);
