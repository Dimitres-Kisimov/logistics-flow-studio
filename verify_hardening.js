...
check(
  "sw.js cache bumped to wt-v49 (and no longer wt-v48)",
  /CACHE_VERSION\s*=\s*"wt-v49"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v48"/.test(swJs),
  "CACHE_VERSION = wt-v49"
);
