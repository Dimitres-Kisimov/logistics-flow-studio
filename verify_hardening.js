 ...
 *       wt-v114 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v113, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v114 (and no longer wt-v113)",
  /CACHE_VERSION\s*=\s*"wt-v114"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v113"/.test(swJs),
  "CACHE_VERSION = wt-v114"
);
