 ...
 *       wt-v122 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v121, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v122 (and no longer wt-v121)",
  /CACHE_VERSION\s*=\s*"wt-v122"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v121"/.test(swJs),
  "CACHE_VERSION = wt-v122"
);
