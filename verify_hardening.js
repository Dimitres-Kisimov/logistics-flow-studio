 ...
 *       wt-v112 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v111, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v112 (and no longer wt-v111)",
  /CACHE_VERSION\s*=\s*"wt-v112"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v111"/.test(swJs),
  "CACHE_VERSION = wt-v112"
);
