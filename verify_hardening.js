 ...
 *       wt-v127 (v3.25 every package takes its own path: order-driven
 ...
 *       around; previously wt-v126, v3.24 the plant reads like a shift).
...
check(
  "sw.js cache bumped to wt-v127 (and no longer wt-v126)",
  /CACHE_VERSION\s*=\s*"wt-v127"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v126"/.test(swJs),
  "CACHE_VERSION = wt-v127"
);
