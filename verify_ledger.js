 ...
 *      flow card block; sw.js precaching ledger.js at wt-v129.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v129 (trail preserved: previously wt-v128)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v129"/.test(sw) && /Previously wt-v128/.test(sw));
