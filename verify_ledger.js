 ...
 *      flow card block; sw.js precaching ledger.js at wt-v130.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v130 (trail preserved: previously wt-v129)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw));
