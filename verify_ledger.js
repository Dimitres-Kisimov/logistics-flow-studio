 ...
 *      flow card block; sw.js precaching ledger.js at wt-v119.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v119 (trail preserved: previously wt-v118)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v119"/.test(sw) && /Previously wt-v118/.test(sw));
