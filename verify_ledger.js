 ...
 *      flow card block; sw.js precaching ledger.js at wt-v118.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v118 (trail preserved: previously wt-v117)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v118"/.test(sw) && /Previously wt-v117/.test(sw));
