 ...
 *      flow card block; sw.js precaching ledger.js at wt-v122.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v122 (trail preserved: previously wt-v121)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v122"/.test(sw) && /Previously wt-v121/.test(sw));
