 ...
 *      flow card block; sw.js precaching ledger.js at wt-v115.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v115 (trail preserved: previously wt-v114)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v115"/.test(sw) && /Previously wt-v114/.test(sw));
