 ...
 *      flow card block; sw.js precaching ledger.js at wt-v138.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v138 (trail preserved: previously wt-v137)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw));
