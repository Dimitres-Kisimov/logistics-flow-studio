 ...
 *      flow card block; sw.js precaching ledger.js at wt-v126.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v126 (trail preserved: previously wt-v125)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v126"/.test(sw) && /Previously wt-v125/.test(sw));
