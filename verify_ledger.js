 ...
 *      flow card block; sw.js precaching ledger.js at wt-v125.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v125 (trail preserved: previously wt-v124)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v125"/.test(sw) && /Previously wt-v124/.test(sw));
