 ...
 *      flow card block; sw.js precaching ledger.js at wt-v136.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v136 (trail preserved: previously wt-v135)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v136"/.test(sw) && /Previously wt-v135/.test(sw));
