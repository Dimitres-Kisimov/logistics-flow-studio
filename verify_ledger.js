 ...
 *      flow card block; sw.js precaching ledger.js at wt-v121.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v121 (trail preserved: previously wt-v120)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v121"/.test(sw) && /Previously wt-v120/.test(sw));
