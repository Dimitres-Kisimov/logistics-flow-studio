 ...
 *      flow card block; sw.js precaching ledger.js at wt-v114.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js precaches ledger.js at wt-v114 (trail preserved: previously wt-v113)", /"\.\/ledger\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v114"/.test(sw) && /Previously wt-v113/.test(sw));
