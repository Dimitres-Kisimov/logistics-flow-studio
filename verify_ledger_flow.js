...
(function () {
  ...
  check("4e. sw.js at wt-v132 (previously wt-v131) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v132"/.test(sw) && /Previously wt-v131/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
