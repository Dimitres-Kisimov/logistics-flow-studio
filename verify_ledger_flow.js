...
(function () {
  ...
  check("4e. sw.js at wt-v139 (previously wt-v138) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v139"/.test(sw) && /Previously wt-v138/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
