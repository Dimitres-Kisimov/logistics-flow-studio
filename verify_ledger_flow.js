...
(function () {
  ...
  check("4e. sw.js at wt-v118 (previously wt-v117) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v118"/.test(sw) && /Previously wt-v117/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
