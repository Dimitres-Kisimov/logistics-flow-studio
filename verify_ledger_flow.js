...
(function () {
  ...
  check("4e. sw.js at wt-v124 (previously wt-v123) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v124"/.test(sw) && /Previously wt-v123/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
