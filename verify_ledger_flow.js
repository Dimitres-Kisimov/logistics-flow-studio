...
(function () {
  ...
  check("4a. the viewer page loads analytics.js after ledger.js and has the section", /<script src="ledger\.js"><\/script>(<script src="tracking\.js"><\/script>)?(<script src="control\.js"><\/script>)?(<script src="ask\.js"><\/script>)?<script src="analytics\.js"><\/script><script src="run-ledger\.js">/.test(html) && /id="rlFlow"/.test(html));
  ...
  check("4e. sw.js at wt-v142 (previously wt-v141) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
