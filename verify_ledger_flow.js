...
(function () {
  ...
  check("4e. sw.js at wt-v144 (previously wt-v143) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v143/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
