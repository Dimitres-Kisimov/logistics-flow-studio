...
(function () {
  ...
  check("4e. sw.js at wt-v137 (previously wt-v136) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v137"/.test(sw) && /Previously wt-v136/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
