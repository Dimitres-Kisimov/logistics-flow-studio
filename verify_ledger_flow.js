...
(function () {
  ...
  check("4e. sw.js at wt-v125 (previously wt-v124) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v125"/.test(sw) && /Previously wt-v124/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
