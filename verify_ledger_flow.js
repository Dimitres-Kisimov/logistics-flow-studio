...
(function () {
  ...
  check("4e. sw.js at wt-v140 (previously wt-v139) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v140"/.test(sw) && /Previously wt-v139/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
