...
(function () {
  ...
  check("4e. sw.js at wt-v136 (previously wt-v135) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v136"/.test(sw) && /Previously wt-v135/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
