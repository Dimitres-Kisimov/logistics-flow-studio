...
(function () {
  ...
  check("4e. sw.js at wt-v138 (previously wt-v137) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
