...
(function () {
  ...
  check("4e. sw.js at wt-v145 (previously wt-v144) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
