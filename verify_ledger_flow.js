...
(function () {
  ...
  check("4e. sw.js at wt-v122 (previously wt-v121) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v122"/.test(sw) && /Previously wt-v121/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
