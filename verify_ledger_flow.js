...
(function () {
  ...
  check("4e. sw.js at wt-v127 (previously wt-v126) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v127"/.test(sw) && /Previously wt-v126/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
