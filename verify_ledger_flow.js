...
(function () {
  ...
  check("4e. sw.js at wt-v130 (previously wt-v129) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
