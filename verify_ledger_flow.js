...
(function () {
  ...
  check("4e. sw.js at wt-v143 (previously wt-v142) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v143"/.test(sw) && /Previously wt-v142/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
