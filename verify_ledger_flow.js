...
(function () {
  ...
  check("4e. sw.js at wt-v148 (previously wt-v147) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
