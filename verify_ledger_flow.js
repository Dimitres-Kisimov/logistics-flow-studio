...
(function () {
  ...
  check("4e. sw.js at wt-v126 (previously wt-v125) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v126"/.test(sw) && /Previously wt-v125/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
