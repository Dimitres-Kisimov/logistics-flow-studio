...
(function () {
  ...
  check("4e. sw.js at wt-v134 (previously wt-v133) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v134"/.test(sw) && /Previously wt-v133/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
