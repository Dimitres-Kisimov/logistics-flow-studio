...
(function () {
  ...
  check("4e. sw.js at wt-v146 (previously wt-v145) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
