...
(function () {
  ...
  check("4e. sw.js at wt-v147 (previously wt-v146) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
