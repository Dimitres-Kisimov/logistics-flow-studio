...
(function () {
  ...
  check("4e. sw.js at wt-v131 (previously wt-v130) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v131"/.test(sw) && /Previously wt-v130/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
