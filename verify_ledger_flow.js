...
(function () {
  ...
  check("4e. sw.js at wt-v141 (previously wt-v140) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v141"/.test(sw) && /Previously wt-v140/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
