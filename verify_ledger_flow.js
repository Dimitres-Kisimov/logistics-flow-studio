...
(function () {
  ...
  check("4a. the viewer page loads analytics.js after ledger.js and has the section", /<script src="ledger\.js"><\/script>(<script src="tracking\.js"><\/script>)?(<script src="control\.js"><\/script>)?<script src="analytics\.js"><\/script><script src="run-ledger\.js">/.test(html) && /id="rlFlow"/.test(html));
  ...
  check("4e. sw.js at wt-v135 (previously wt-v134) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v135"/.test(sw) && /Previously wt-v134/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
