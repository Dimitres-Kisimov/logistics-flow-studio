...
(function () {
  ...
  check("4e. sw.js at wt-v119 (previously wt-v118) precaches analytics.js and the viewer", /CACHE_VERSION\s*=\s*"wt-v119"/.test(sw) && /Previously wt-v118/.test(sw) && /"\.\/analytics\.js"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw));
