...
(function () {
  ...
  check("6f. sw.js at wt-v137 (previously wt-v136); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v137"/.test(sw) && /Previously wt-v136/.test(sw) && /verify_library_preview\.js/.test(runall));
