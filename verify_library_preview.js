...
(function () {
  ...
  check("6f. sw.js at wt-v146 (previously wt-v145); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw) && /verify_library_preview\.js/.test(runall));
