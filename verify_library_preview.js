...
(function () {
  ...
  check("6f. sw.js at wt-v130 (previously wt-v129); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw) && /verify_library_preview\.js/.test(runall));
