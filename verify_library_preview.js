...
(function () {
  ...
  check("6f. sw.js at wt-v143 (previously wt-v142); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v143"/.test(sw) && /Previously wt-v142/.test(sw) && /verify_library_preview\.js/.test(runall));
