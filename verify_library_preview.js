...
(function () {
  ...
  check("6f. sw.js at wt-v139 (previously wt-v138); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v139"/.test(sw) && /Previously wt-v138/.test(sw) && /verify_library_preview\.js/.test(runall));
