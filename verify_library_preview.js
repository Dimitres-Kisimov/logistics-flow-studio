...
(function () {
  ...
  check("6f. sw.js at wt-v133 (previously wt-v132); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v133"/.test(sw) && /Previously wt-v132/.test(sw) && /verify_library_preview\.js/.test(runall));
