...
(function () {
  ...
  check("6f. sw.js at wt-v147 (previously wt-v146); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw) && /verify_library_preview\.js/.test(runall));
