...
(function () {
  ...
  check("6f. sw.js at wt-v140 (previously wt-v139); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v140"/.test(sw) && /Previously wt-v139/.test(sw) && /verify_library_preview\.js/.test(runall));
