...
(function () {
  ...
  check("6f. sw.js at wt-v142 (previously wt-v141); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw) && /verify_library_preview\.js/.test(runall));
