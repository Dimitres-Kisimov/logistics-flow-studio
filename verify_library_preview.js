...
(function () {
  ...
  check("6f. sw.js at wt-v138 (previously wt-v137); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw) && /verify_library_preview\.js/.test(runall));
