...
(function () {
  ...
  check("6f. sw.js at wt-v136 (previously wt-v135); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v136"/.test(sw) && /Previously wt-v135/.test(sw) && /verify_library_preview\.js/.test(runall));
