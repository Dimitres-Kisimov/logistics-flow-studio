...
(function () {
  ...
  check("6f. sw.js at wt-v135 (previously wt-v134); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v135"/.test(sw) && /Previously wt-v134/.test(sw) && /verify_library_preview\.js/.test(runall));
