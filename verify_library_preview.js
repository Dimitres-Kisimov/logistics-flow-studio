...
(function () {
  ...
  check("6f. sw.js at wt-v148 (previously wt-v147); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw) && /verify_library_preview\.js/.test(runall));
