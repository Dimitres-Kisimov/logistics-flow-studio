...
(function () {
  ...
  check("6f. sw.js at wt-v141 (previously wt-v140); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v141"/.test(sw) && /Previously wt-v140/.test(sw) && /verify_library_preview\.js/.test(runall));
