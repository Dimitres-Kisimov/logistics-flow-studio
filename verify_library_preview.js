...
(function () {
  ...
  check("6f. sw.js at wt-v134 (previously wt-v133); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v134"/.test(sw) && /Previously wt-v133/.test(sw) && /verify_library_preview\.js/.test(runall));
