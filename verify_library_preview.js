...
(function () {
  ...
  check("6f. sw.js at wt-v145 (previously wt-v144); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw) && /verify_library_preview\.js/.test(runall));
