...
(function () {
  ...
  check("6f. sw.js at wt-v144 (previously wt-v143); the runner lists this harness", /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v143/.test(sw) && /verify_library_preview\.js/.test(runall));
