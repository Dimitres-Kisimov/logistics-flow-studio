 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v82
...
check("sw.js cache bumped to wt-v82 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v82"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v82");
