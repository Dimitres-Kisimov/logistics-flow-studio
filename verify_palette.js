 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v81
...
check("sw.js cache bumped to wt-v81 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v81"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v81");
