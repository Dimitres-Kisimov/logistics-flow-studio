 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v106
...
check("sw.js cache bumped to wt-v106 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v106"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v106");
