 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v104
...
check("sw.js cache bumped to wt-v104 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v104"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v104");
