 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v60
...
check("sw.js cache bumped to wt-v60 (and no longer wt-v59)",
  /CACHE_VERSION\s*=\s*"wt-v60"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v59"/.test(swJs),
  "CACHE_VERSION = wt-v60");
