 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v85
...
check("sw.js cache bumped to wt-v85 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v85"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v85");
