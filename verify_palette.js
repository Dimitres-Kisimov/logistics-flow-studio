 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v74
...
check("sw.js cache bumped to wt-v75 (and no longer wt-v74)",
  /CACHE_VERSION\s*=\s*"wt-v75"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v74"/.test(swJs),
  "CACHE_VERSION = wt-v75");
