 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v59
...
check("sw.js cache bumped to wt-v59 (and no longer wt-v58)",
  /CACHE_VERSION\s*=\s*"wt-v59"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v58"/.test(swJs),
  "CACHE_VERSION = wt-v59");
