 ...
 *     the actionKey switch; sw.js precaches ./palette.js at wt-v95
...
check("sw.js cache bumped to wt-v95 (and no longer wt-v79)",
  /CACHE_VERSION\s*=\s*"wt-v95"/.test(swJs) && !/CACHE_VERSION\s*=\s*"wt-v79"/.test(swJs),
  "CACHE_VERSION = wt-v95");
