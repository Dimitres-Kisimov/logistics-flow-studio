...
(function () {
  ...
  check("6a. index.html loads people.js before app.js and offers the picker with its two options and the hint that names the step-and-shift rule; sw.js precaches it at wt-v144 (previously wt-v143); run-all lists this harness",
    ...
    /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v143/.test(sw) && /verify_people\.js/.test(runall));
