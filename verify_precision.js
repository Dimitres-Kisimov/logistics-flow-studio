 ...
 *      string, sw.js precaching C at wt-v126, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v126 (previously wt-v125)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v126"/.test(sw) && /Previously wt-v125/.test(sw));
