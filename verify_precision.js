 ...
 *      string, sw.js precaching C at wt-v142, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v142 (previously wt-v141)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw));
