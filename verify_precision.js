 ...
 *      string, sw.js precaching C at wt-v140, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v140 (previously wt-v139)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v140"/.test(sw) && /Previously wt-v139/.test(sw));
