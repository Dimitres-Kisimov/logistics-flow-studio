 ...
 *      string, sw.js precaching C at wt-v129, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v129 (previously wt-v128)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v129"/.test(sw) && /Previously wt-v128/.test(sw));
