 ...
 *      string, sw.js precaching C at wt-v139, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v139 (previously wt-v138)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v139"/.test(sw) && /Previously wt-v138/.test(sw));
