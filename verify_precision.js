 ...
 *      string, sw.js precaching C at wt-v144, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v144 (previously wt-v143)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v143/.test(sw));
