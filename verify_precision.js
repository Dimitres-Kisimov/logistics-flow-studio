 ...
 *      string, sw.js precaching C at wt-v145, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v145 (previously wt-v144)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw));
