 ...
 *      string, sw.js precaching C at wt-v146, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v146 (previously wt-v145)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw));
