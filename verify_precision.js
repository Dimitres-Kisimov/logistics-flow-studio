 ...
 *      string, sw.js precaching C at wt-v141, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v141 (previously wt-v140)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v141"/.test(sw) && /Previously wt-v140/.test(sw));
