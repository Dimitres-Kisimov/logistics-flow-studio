 ...
 *      string, sw.js precaching C at wt-v148, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v148 (previously wt-v147)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw));
