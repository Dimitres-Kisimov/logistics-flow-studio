 ...
 *      string, sw.js precaching C at wt-v131, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v131 (previously wt-v130)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v131"/.test(sw) && /Previously wt-v130/.test(sw));
