 ...
 *      string, sw.js precaching C at wt-v137, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v137 (previously wt-v136)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v137"/.test(sw) && /Previously wt-v136/.test(sw));
