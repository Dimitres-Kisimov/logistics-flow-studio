 ...
 *      string, sw.js precaching C at wt-v130, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v130 (previously wt-v129)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw));
