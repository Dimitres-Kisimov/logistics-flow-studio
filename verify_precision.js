 ...
 *      string, sw.js precaching C at wt-v143, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v143 (previously wt-v142)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v143"/.test(sw) && /Previously wt-v142/.test(sw));
