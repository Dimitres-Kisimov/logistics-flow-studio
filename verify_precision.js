 ...
 *      string, sw.js precaching C at wt-v128, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v128 (previously wt-v127)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v128"/.test(sw) && /Previously wt-v127/.test(sw));
