 ...
 *      string, sw.js precaching C at wt-v138, the reconcile command and
...
(function () {
  ...
  check("4c. sw.js precaches fixture C at wt-v138 (previously wt-v137)", /"\.\/test\/fixtures\/run-ledger-c\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw));
