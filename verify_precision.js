...
(function () {
  ...
  check("4d. tools/run_ledger.py has the reconcile command over 14 views with the two tolerances", /def reconcile\(/.test(py) && /"reconcile"/.test(py) && (py.match(/"v_[a-z_]+": \(/g) || []).length === 14 && /--tolerance-raw/.test(py));
