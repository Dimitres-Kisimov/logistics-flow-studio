 ...
 *      through the same combiner, the knowledge base, the docs, wt-v145.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("7g. shipped: the runner lists this harness, the service worker is at wt-v145 (previously wt-v144), README and CHANGELOG carry v3.67",
    /verify_psf\.js/.test(read(path.join("test", "run-all.mjs"))) && /wt-v145/.test(read("sw.js")) && /Previously wt-v144/.test(read("sw.js")) &&
