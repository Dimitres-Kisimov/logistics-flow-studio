 ...
 *      against the code, the tool, the runner, wt-v146.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("7e. shipped: the runner lists this harness, the tool exists, the service worker is at wt-v146 (previously wt-v145), README and CHANGELOG carry v3.68",
    /verify_routegraph\.js/.test(read(path.join("test", "run-all.mjs"))) && fs.existsSync(path.join(__dirname, "tools", "route_graph.mjs")) &&
    /wt-v146/.test(read("sw.js")) && /Previously wt-v145/.test(read("sw.js")) && /v3\.68/.test(read("README.md")) && /## v3\.68/.test(read("CHANGELOG.md")));
})();
