 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v126 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v126 cache (trail preserved: previously wt-v125)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v126"/.test(SW_SRC) &&
    /Previously wt-v125/.test(SW_SRC));
