 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v88 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v88 cache (trail preserved: previously wt-v79)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v88"/.test(SW_SRC) &&
