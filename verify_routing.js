 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v121 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v121 cache (trail preserved: previously wt-v120)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v121"/.test(SW_SRC) &&
    /Previously wt-v120/.test(SW_SRC));
