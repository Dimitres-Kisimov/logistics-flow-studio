 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v134 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v134 cache (trail preserved: previously wt-v133)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v134"/.test(SW_SRC) &&
    /Previously wt-v133/.test(SW_SRC));
