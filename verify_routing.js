 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v141 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v141 cache (trail preserved: previously wt-v140)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v141"/.test(SW_SRC) &&
    /Previously wt-v140/.test(SW_SRC));
