 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v145 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v145 cache (trail preserved: previously wt-v144)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(SW_SRC) &&
    /Previously wt-v144/.test(SW_SRC));
