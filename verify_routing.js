 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v144 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v144 cache (trail preserved: previously wt-v143)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v144"/.test(SW_SRC) &&
    /Previously wt-v143/.test(SW_SRC));
