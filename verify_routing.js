 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v120 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v120 cache (trail preserved: previously wt-v119)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v120"/.test(SW_SRC) &&
    /Previously wt-v119/.test(SW_SRC));
