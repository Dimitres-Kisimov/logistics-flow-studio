 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v127 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v127 cache (trail preserved: previously wt-v126)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v127"/.test(SW_SRC) &&
    /Previously wt-v126/.test(SW_SRC));
