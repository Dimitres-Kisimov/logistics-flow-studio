 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v146 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v146 cache (trail preserved: previously wt-v145)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v146"/.test(SW_SRC) &&
    /Previously wt-v145/.test(SW_SRC));
