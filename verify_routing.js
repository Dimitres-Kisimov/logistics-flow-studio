 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v139 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v139 cache (trail preserved: previously wt-v138)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v139"/.test(SW_SRC) &&
    /Previously wt-v138/.test(SW_SRC));
