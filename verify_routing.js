 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v122 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v122 cache (trail preserved: previously wt-v121)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v122"/.test(SW_SRC) &&
    /Previously wt-v121/.test(SW_SRC));
