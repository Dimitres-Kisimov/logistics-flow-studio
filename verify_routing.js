 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v112 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v112 cache (trail preserved: previously wt-v111)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v112"/.test(SW_SRC) &&
    /Previously wt-v111/.test(SW_SRC));
