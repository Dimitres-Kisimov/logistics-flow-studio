 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v119 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v119 cache (trail preserved: previously wt-v118)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v119"/.test(SW_SRC) &&
    /Previously wt-v118/.test(SW_SRC));
