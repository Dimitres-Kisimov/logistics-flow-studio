 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v136 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v136 cache (trail preserved: previously wt-v135)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v136"/.test(SW_SRC) &&
    /Previously wt-v135/.test(SW_SRC));
