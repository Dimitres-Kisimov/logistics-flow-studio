 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v125 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v125 cache (trail preserved: previously wt-v124)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v125"/.test(SW_SRC) &&
    /Previously wt-v124/.test(SW_SRC));
