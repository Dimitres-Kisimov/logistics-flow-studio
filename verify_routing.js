 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v114 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v114 cache (trail preserved: previously wt-v113)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v114"/.test(SW_SRC) &&
    /Previously wt-v113/.test(SW_SRC));
