 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v123 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v123 cache (trail preserved: previously wt-v122)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v123"/.test(SW_SRC) &&
    /Previously wt-v122/.test(SW_SRC));
