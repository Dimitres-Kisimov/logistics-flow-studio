 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v135 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v135 cache (trail preserved: previously wt-v134)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v135"/.test(SW_SRC) &&
    /Previously wt-v134/.test(SW_SRC));
