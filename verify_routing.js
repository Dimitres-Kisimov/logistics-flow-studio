 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v115 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v115 cache (trail preserved: previously wt-v114)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v115"/.test(SW_SRC) &&
    /Previously wt-v114/.test(SW_SRC));
