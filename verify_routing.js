 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v124 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v124 cache (trail preserved: previously wt-v123)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v124"/.test(SW_SRC) &&
    /Previously wt-v123/.test(SW_SRC));
