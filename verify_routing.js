 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v143 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v143 cache (trail preserved: previously wt-v142)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v143"/.test(SW_SRC) &&
    /Previously wt-v142/.test(SW_SRC));
