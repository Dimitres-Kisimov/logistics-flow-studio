 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v138 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v138 cache (trail preserved: previously wt-v137)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v138"/.test(SW_SRC) &&
    /Previously wt-v137/.test(SW_SRC));
