 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v118 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v118 cache (trail preserved: previously wt-v117)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v118"/.test(SW_SRC) &&
    /Previously wt-v117/.test(SW_SRC));
