 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v142 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v142 cache (trail preserved: previously wt-v141)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v142"/.test(SW_SRC) &&
    /Previously wt-v141/.test(SW_SRC));
