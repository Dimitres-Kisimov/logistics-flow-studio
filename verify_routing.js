 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v137 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v137 cache (trail preserved: previously wt-v136)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v137"/.test(SW_SRC) &&
    /Previously wt-v136/.test(SW_SRC));
