 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v148 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v148 cache (trail preserved: previously wt-v147)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v148"/.test(SW_SRC) &&
    /Previously wt-v147/.test(SW_SRC));
