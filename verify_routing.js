 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v140 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v140 cache (trail preserved: previously wt-v139)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v140"/.test(SW_SRC) &&
    /Previously wt-v139/.test(SW_SRC));
