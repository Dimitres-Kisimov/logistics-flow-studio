 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v147 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v147 cache (trail preserved: previously wt-v146)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v147"/.test(SW_SRC) &&
    /Previously wt-v146/.test(SW_SRC));
