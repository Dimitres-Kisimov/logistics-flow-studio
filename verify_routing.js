 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v129 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v129 cache (trail preserved: previously wt-v128)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v129"/.test(SW_SRC) &&
    /Previously wt-v128/.test(SW_SRC));
