 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v128 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v128 cache (trail preserved: previously wt-v127)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v128"/.test(SW_SRC) &&
    /Previously wt-v127/.test(SW_SRC));
