 ...
 *       flowsim.js, precached by sw.js at the bumped wt-v113 cache, and
...
(() => {
  ...
  check("11b. sw.js precaches ./routing.js at the bumped wt-v113 cache (trail preserved: previously wt-v112)",
    /["']\.\/routing\.js["']/.test(SW_SRC) && /CACHE_VERSION\s*=\s*"wt-v113"/.test(SW_SRC) &&
    /Previously wt-v112/.test(SW_SRC));
