 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v122, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v122 (previously wt-v121)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v122"/.test(sw) && /Previously wt-v121/.test(sw));
