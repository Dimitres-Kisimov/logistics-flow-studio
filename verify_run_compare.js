 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v146, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v146 (previously wt-v145)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v146"/.test(sw) && /Previously wt-v145/.test(sw));
