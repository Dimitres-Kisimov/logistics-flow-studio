 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v132, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v132 (previously wt-v131)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v132"/.test(sw) && /Previously wt-v131/.test(sw));
