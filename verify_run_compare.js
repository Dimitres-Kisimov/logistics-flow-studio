 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v147, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v147 (previously wt-v146)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw));
