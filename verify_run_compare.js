 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v119, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v119 (previously wt-v118)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v119"/.test(sw) && /Previously wt-v118/.test(sw));
