 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v125, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v125 (previously wt-v124)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v125"/.test(sw) && /Previously wt-v124/.test(sw));
