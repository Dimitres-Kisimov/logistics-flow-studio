 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v135, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v135 (previously wt-v134)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v135"/.test(sw) && /Previously wt-v134/.test(sw));
