 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v130, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v130 (previously wt-v129)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw));
