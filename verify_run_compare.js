 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v145, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v145 (previously wt-v144)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw));
