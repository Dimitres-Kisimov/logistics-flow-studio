 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v141, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v141 (previously wt-v140)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v141"/.test(sw) && /Previously wt-v140/.test(sw));
