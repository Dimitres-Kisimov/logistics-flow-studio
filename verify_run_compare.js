 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v123, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v123 (previously wt-v122)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v123"/.test(sw) && /Previously wt-v122/.test(sw));
  ...
  check("3d. the fixture script builds the variants and documents them", /run-ledger-b/.test(mk) && /MIX_B/.test(mk) && /\[a\|b\|c\|all\]/.test(mk));
