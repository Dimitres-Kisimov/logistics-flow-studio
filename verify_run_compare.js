 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v128, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v128 (previously wt-v127)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v128"/.test(sw) && /Previously wt-v127/.test(sw));
