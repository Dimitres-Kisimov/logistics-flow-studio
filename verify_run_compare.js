 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v142, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v142 (previously wt-v141)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw));
