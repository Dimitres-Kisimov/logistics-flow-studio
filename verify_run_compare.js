 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v140, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v140 (previously wt-v139)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v140"/.test(sw) && /Previously wt-v139/.test(sw));
