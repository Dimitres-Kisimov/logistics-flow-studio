 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v134, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v134 (previously wt-v133)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v134"/.test(sw) && /Previously wt-v133/.test(sw));
