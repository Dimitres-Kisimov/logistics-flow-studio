 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v129, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v129 (previously wt-v128)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v129"/.test(sw) && /Previously wt-v128/.test(sw));
