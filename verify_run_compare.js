 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v127, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v127 (previously wt-v126)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v127"/.test(sw) && /Previously wt-v126/.test(sw));
