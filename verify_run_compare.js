 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v143, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v143 (previously wt-v142)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v143"/.test(sw) && /Previously wt-v142/.test(sw));
