 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v126, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v126 (previously wt-v125)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v126"/.test(sw) && /Previously wt-v125/.test(sw));
