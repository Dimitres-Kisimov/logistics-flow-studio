 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v133, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v133 (previously wt-v132)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v133"/.test(sw) && /Previously wt-v132/.test(sw));
