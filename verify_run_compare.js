 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v148, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v148 (previously wt-v147)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw));
