 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v131, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v131 (previously wt-v130)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v131"/.test(sw) && /Previously wt-v130/.test(sw));
