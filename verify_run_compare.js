 ...
 *      section, sw.js precaching run-ledger-b.json at wt-v124, the SQL views
...
(function () {
  ...
  check("3b. sw.js precaches fixture B at wt-v124 (previously wt-v123)", /"\.\/test\/fixtures\/run-ledger-b\.json"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v124"/.test(sw) && /Previously wt-v123/.test(sw));
