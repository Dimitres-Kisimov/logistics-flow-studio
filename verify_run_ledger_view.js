 ...
 *      at wt-v129; the planner has the hand-over button; the offline guard
...
(function () {
  ...
  check("4b. sw.js precaches the page, its script, stylesheet and the recorded example at wt-v129 (previously wt-v128)",
    /"\.\/run-ledger\.html"/.test(sw) && /"\.\/run-ledger\.js"/.test(sw) && /"\.\/run-ledger\.css"/.test(sw) && /"\.\/test\/fixtures\/run-ledger\.json"/.test(sw) &&
    /CACHE_VERSION\s*=\s*"wt-v129"/.test(sw) && /Previously wt-v128/.test(sw));
...
(function () {
  ...
  check("5a. run-ledger-sql.js carries exactly the 29 views in the tool's order", !!G && JSON.stringify(Object.keys(G)) === JSON.stringify(SQL_NAMES), G ? Object.keys(G).length + " keys" : "missing");
