 ...
 *      run-all; sw.js at wt-v142; verify_control updated; README, CHANGELOG,
...
(function () {
  ...
  check("3c. the knowledge base's control category carries control.search.minGainHalfWidths (1); the self-test lever-search-rule-proposes-from-a-table; run-all lists verify_search.js; sw.js at wt-v142 (previously wt-v141); verify_control pins five rules and eight thresholds",
    /id: "control\.search\.minGainHalfWidths"/.test(kb) && WT.kb.get("control.search.minGainHalfWidths") === 1 && /lever-search-rule-proposes-from-a-table/.test(st) && /verify_search\.js/.test(runall) && /CACHE_VERSION\s*=\s*"wt-v142"/.test(sw) && /Previously wt-v141/.test(sw) &&
