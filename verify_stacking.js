 ...
 *      sw.js at wt-v147, the runner; no Date / Math.random in pack.js.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js at wt-v147 (previously wt-v146)", /CACHE_VERSION\s*=\s*"wt-v147"/.test(sw) && /Previously wt-v146/.test(sw));
