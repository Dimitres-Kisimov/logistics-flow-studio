 ...
 *      sw.js at wt-v148, the runner; no Date / Math.random in pack.js.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js at wt-v148 (previously wt-v147)", /CACHE_VERSION\s*=\s*"wt-v148"/.test(sw) && /Previously wt-v147/.test(sw));
