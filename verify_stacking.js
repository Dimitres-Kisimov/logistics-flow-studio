 ...
 *      sw.js at wt-v130, the runner; no Date / Math.random in pack.js.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js at wt-v130 (previously wt-v129)", /CACHE_VERSION\s*=\s*"wt-v130"/.test(sw) && /Previously wt-v129/.test(sw));
