 ...
 *      sw.js at wt-v123, the runner; no Date / Math.random in pack.js.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js at wt-v123 (previously wt-v122)", /CACHE_VERSION\s*=\s*"wt-v123"/.test(sw) && /Previously wt-v122/.test(sw));
