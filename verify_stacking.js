 ...
 *      sw.js at wt-v133, the runner; no Date / Math.random in pack.js.
 * ===================================================================== */
"use strict";
const fs = require("fs");
...
(function () {
  ...
  check("8d. sw.js at wt-v133 (previously wt-v132)", /CACHE_VERSION\s*=\s*"wt-v133"/.test(sw) && /Previously wt-v132/.test(sw));
