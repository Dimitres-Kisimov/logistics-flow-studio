 ...
 *       precaches ./story.js at the bumped wt-v58 cache (previously wt-v57), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v58/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v58 cache; app.js wires + sequences it",
