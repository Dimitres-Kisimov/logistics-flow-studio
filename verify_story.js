 ...
 *       precaches ./story.js at the bumped wt-v51 cache (previously wt-v50), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v51/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v51 cache; app.js wires + sequences it",
