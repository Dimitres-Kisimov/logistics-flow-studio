 ...
 *       precaches ./story.js at the bumped wt-v65 cache (previously wt-v64), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v65/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v65 cache; app.js wires + sequences it",
