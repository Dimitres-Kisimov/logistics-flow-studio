 ...
 *       precaches ./story.js at the bumped wt-v54 cache (previously wt-v53), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v54/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v54 cache; app.js wires + sequences it",
