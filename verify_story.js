 ...
 *       precaches ./story.js at the bumped wt-v59 cache (previously wt-v58), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v59/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v59 cache; app.js wires + sequences it",
