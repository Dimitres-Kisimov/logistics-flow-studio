 ...
 *       precaches ./story.js at the bumped wt-v57 cache (previously wt-v56), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v57/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v57 cache; app.js wires + sequences it",
