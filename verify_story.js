 ...
 *       precaches ./story.js at the bumped wt-v47 cache, and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v47/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v47 cache; app.js wires + sequences it",
