 ...
 *       precaches ./story.js at the bumped wt-v60 cache (previously wt-v59), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v60/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v60 cache; app.js wires + sequences it",
