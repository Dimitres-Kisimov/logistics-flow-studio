 ...
 *       precaches ./story.js at the bumped wt-v53 cache (previously wt-v52), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v53/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v53 cache; app.js wires + sequences it",
