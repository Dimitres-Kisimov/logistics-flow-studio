 ...
 *       precaches ./story.js at the bumped wt-v43 cache, and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v43/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v43 cache; app.js wires + sequences it",
