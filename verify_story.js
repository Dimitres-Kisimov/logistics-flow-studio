 ...
 *       precaches ./story.js at the bumped wt-v52 cache (previously wt-v51), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v52/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v52 cache; app.js wires + sequences it",
