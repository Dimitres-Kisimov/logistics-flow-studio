 ...
 *       precaches ./story.js at the bumped wt-v61 cache (previously wt-v60), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v61/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v61 cache; app.js wires + sequences it",
