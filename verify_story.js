 ...
 *       precaches ./story.js at the bumped wt-v56 cache (previously wt-v55), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v56/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v56 cache; app.js wires + sequences it",
