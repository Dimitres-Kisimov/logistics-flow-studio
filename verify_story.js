 ...
 *       precaches ./story.js at the bumped wt-v44 cache, and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v44/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v44 cache; app.js wires + sequences it",
