 ...
 *       precaches ./story.js at the bumped wt-v66 cache (previously wt-v65), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v66/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v66 cache; app.js wires + sequences it",
