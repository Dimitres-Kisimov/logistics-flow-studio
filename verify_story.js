 ...
 *       precaches ./story.js at the bumped wt-v71 cache (previously wt-v70), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v71/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v71 cache; app.js wires + sequences it",
