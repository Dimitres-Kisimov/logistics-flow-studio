 ...
 *       precaches ./story.js at the bumped wt-v72 cache (previously wt-v71), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v72/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v72 cache; app.js wires + sequences it",
