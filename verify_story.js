 ...
 *       precaches ./story.js at the bumped wt-v50 cache (previously wt-v49), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v50/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v50 cache; app.js wires + sequences it",
