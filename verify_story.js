 ...
 *       precaches ./story.js at the bumped wt-v62 cache (previously wt-v61), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v62/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v62 cache; app.js wires + sequences it",
