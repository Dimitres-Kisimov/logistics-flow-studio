 ...
 *       precaches ./story.js at the bumped wt-v55 cache (previously wt-v54), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v55/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v55 cache; app.js wires + sequences it",
