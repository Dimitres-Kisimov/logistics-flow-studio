 ...
 *       precaches ./story.js at the bumped wt-v49 cache (previously wt-v48), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v49/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v49 cache; app.js wires + sequences it",
