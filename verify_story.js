 ...
 *       precaches ./story.js at the bumped wt-v67 cache (previously wt-v66), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v67/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v67 cache; app.js wires + sequences it",
