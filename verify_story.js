 ...
 *       precaches ./story.js at the bumped wt-v68 cache (previously wt-v67), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v68/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v68 cache; app.js wires + sequences it",
