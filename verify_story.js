 ...
 *       precaches ./story.js at the bumped wt-v69 cache (previously wt-v68), and app.js wires the
...
(async function runTests() {
  ...
  const swCaches = /["']\.\/story\.js["']/.test(sw) && /wt-v69/.test(sw);
  ...
  check(
    "sw.js precaches ./story.js at the bumped wt-v69 cache; app.js wires + sequences it",
