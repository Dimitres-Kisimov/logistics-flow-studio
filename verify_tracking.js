 ...
 *      ledger.js; sw.js precaches it at wt-v144; run-all lists this file; the
...
(function () {
  ...
  check("8b. sw.js precaches ./tracking.js at wt-v144 (trail preserved: previously wt-v143)", /"\.\/tracking\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v144"/.test(sw) && /Previously wt-v143/.test(sw));
