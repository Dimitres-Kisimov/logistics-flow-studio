 ...
 *      ledger.js; sw.js precaches it at wt-v145; run-all lists this file; the
...
(function () {
  ...
  check("8b. sw.js precaches ./tracking.js at wt-v145 (trail preserved: previously wt-v144)", /"\.\/tracking\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v145"/.test(sw) && /Previously wt-v144/.test(sw));
