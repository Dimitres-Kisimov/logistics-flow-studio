 ...
 *      ledger.js; sw.js precaches it at wt-v140; run-all lists this file; the
...
(function () {
  ...
  check("8b. sw.js precaches ./tracking.js at wt-v140 (trail preserved: previously wt-v139)", /"\.\/tracking\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v140"/.test(sw) && /Previously wt-v139/.test(sw));
