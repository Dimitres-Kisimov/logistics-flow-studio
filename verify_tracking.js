 ...
 *      ledger.js; sw.js precaches it at wt-v138; run-all lists this file; the
...
(function () {
  ...
  check("8b. sw.js precaches ./tracking.js at wt-v138 (trail preserved: previously wt-v137)", /"\.\/tracking\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v138"/.test(sw) && /Previously wt-v137/.test(sw));
