 ...
 *      ledger.js; sw.js precaches it at wt-v134; run-all lists this file; the
...
(function () {
  ...
  check("8b. sw.js precaches ./tracking.js at wt-v134 (trail preserved: previously wt-v133)", /"\.\/tracking\.js"/.test(sw) && /CACHE_VERSION\s*=\s*"wt-v134"/.test(sw) && /Previously wt-v133/.test(sw));
